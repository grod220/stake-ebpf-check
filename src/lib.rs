...
pub extern "C" fn entrypoint(arg: u64) -> u64 {
    ...
    let activation = calculate_activation_allowance(arg, account_stake, &cluster_state, Some(arg / 3));
    let deactivation = calculate_deactivation_allowance(arg, (account_stake / 2) + 1, &cluster_state, Some(arg / 5));
